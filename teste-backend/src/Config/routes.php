...
$app->group('/products', function (RouteCollectorProxy $group) {
    ...
    $group->get('/filter', [ProductController::class, 'getFiltered']); // rota estática definida antes
    $group->get('/{id}', [ProductController::class, 'getOne']); // rota variável movida para o final
